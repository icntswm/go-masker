...
//
// A Masker does not mutate input values, returns normalized copies of supported
// containers, and is safe for concurrent use after construction. The package
...
// values; detailed safe context is available through errors.As. A Masker is
// immutable and safe for concurrent use after construction. The httpmask
